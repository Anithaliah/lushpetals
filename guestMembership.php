          ...
          <div class="row">
            <div class="col-lg-4">
              <div class="item">
                ...
                <h4>Basic</h4>
                <p>$0.00 (FREE) <br>Exclusive floral access <br>Access to new flower varieties</p>
            ...
            <div class="col-lg-4">
              <div class="item">
                ...
                <h4>Standard</h4>
                <p>$50.00 <br>Access to exclusive flower varieties <br>Rm10 off every purchase</p>
                <div class="main-button">
                <form method="POST" action="login.php">
            ...
            <div class="col-lg-4">
              <div class="item">
                ...
                <h4>Premium</h4>
                <p>$150.00<br>Daily delivery of exotic flowers <br>Free Delivery for every purchase</p>
                <div class="main-button">
                <form method="POST" action="login.php">
